...
class ShieldSeeder extends Seeder
{
    ...
    */
    public function run()
    {
        ...
        $rolesWithPermissions = '[{"name":"super_admin","guard_name":"web","permissions":["view_role","view_any_role","create_role","update_role","delete_role","delete_any_role"]},{"name":"user","guard_name":"web","permissions":[]}]';
        $directPermissions = '[]';
